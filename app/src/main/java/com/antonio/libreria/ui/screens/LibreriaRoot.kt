...
@Composable
fun LibreriaRoot(navController: NavHostController, viewModel: LibreriaViewModel) {
    Scaffold(
        topBar = {
            MyTopBarRoot(navController,viewModel)
        },
        content = {padding ->
            ContenidoRoot(navController,viewModel)
        }
    )
...
@OptIn(ExperimentalMaterial3Api::class)
@Composable
fun MyTopBarRoot(navController: NavHostController, viewModel: LibreriaViewModel) {
...
@Composable
fun ContenidoRoot(navController: NavHostController, viewModel: LibreriaViewModel) {
    val context = LocalContext.current
...
@Composable
fun ItemLibrosRoot(viewModel: LibreriaViewModel, libro: Libro, navController: NavHostController) {
...
@Composable
fun MyDialogBorrarLibroRoot(onDismiss: () -> Unit, onAccept: () -> Unit) {
    ...
    AlertDialog(
        ...
        text = {
            Text(text = "¿Estás seguro de que deseas Borrar este libro?")
        },
        confirmButton = {
            Button(
                onClick = {
